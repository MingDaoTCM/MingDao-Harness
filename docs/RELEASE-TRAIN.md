...
- [ ] 3b. **v0.5.1**：内容 = v0.5.0 之后的**修复类**改动（审计收口 T19–T22、约束引擎
      fail-open 安全修复 T25–T29、Windows CI 修复）；账本 C1 与回放 C2 属**新功能**，
      留到 v0.6.0。若从 main 打 tag 会带上新功能，因此需从 v0.5.0 拉 release 分支挑拣修复
      （**待负责人确认是否需要这么严格**；若接受「新功能随补丁版一起发」，可直接用 main）
